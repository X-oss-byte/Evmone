...
TEST_P(evm, eof_function_example1)
{
    ...
    rev = EVMC_CANCUN;
    const auto code = "EF00 01 010008 020002 000f 0002 030000 00 00800002 02010002" +
...
TEST_P(evm, eof_function_example2)
{
    ...
    rev = EVMC_CANCUN;
    const auto code =
        "ef0001 01000c 020003 003b 0017 001d 030000 00 00800004 01010003 01010004"
...
TEST_P(evm, callf_stack_size_1024)
{
    ...
    rev = EVMC_CANCUN;
    const auto code = bytecode{"ef0001 010008 020002 0BFF 0004 030000 00 008003FF 00000001"_hex} +
...
TEST_P(evm, callf_stack_overflow)
{
    ...
    rev = EVMC_CANCUN;
    const auto code =
        bytecode{"ef0001 010008 020002 0BFF 0007 030000 00 008003FF 00000002"_hex} +  // EOF header
...
TEST_P(evm, callf_call_stack_size_1024)
{
    ...
    rev = EVMC_CANCUN;
    const auto code = bytecode{"ef0001 010008 020002 0007 000e 030000 00 00800001 01000002"_hex} +
...
TEST_P(evm, minimal_jumpf)
{
    ...
    rev = EVMC_CANCUN;
    const auto code = bytecode{"ef0001 010008 020002 0003 0001 030000 00 00800000 00800000"_hex} +
...
TEST_P(evm, jumpf_to_returning_function)
{
    ...
    rev = EVMC_CANCUN;
    const auto code =
        bytecode{"ef0001 01000c 020003 0009 0005 0004 030000 00 00800002 00010001 01010002"_hex} +
        // function 0
...
TEST_P(evm, jumpf_to_function_with_fewer_outputs)
{
    ...
    rev = EVMC_CANCUN;
    const auto code =
        bytecode{"ef0001 01000c 020003 0009 0007 0004 030000 00 00800003 00020002 01010002"_hex} +
        // function 0
        OP_CALLF + "0001" + OP_PUSH0 + OP_MSTORE + OP_PUSH1 + "20" + OP_PUSH0 + OP_RETURN +
