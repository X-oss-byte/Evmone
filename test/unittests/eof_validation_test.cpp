...
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030000 00 00800000 FE"),
        EOFValidationError::success);
}

TEST(eof_validation, minimal_valid_EOF1_code_with_data)
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030001 00 00800000 FE DA"),
        EOFValidationError::success);
}
...
TEST(eof_validation, minimal_valid_EOF1_multiple_code_sections)
{
    ...
    // with data section
    EXPECT_EQ(validate_eof("EF0001 010008 02000200010001 030001 00  00800000 00800000  FE FE DA"),
        EOFValidationError::success);
...
TEST(eof_validation, EOF1_code_section_missing)
{
    ...
    EXPECT_EQ(validate_eof("EF0001 010004 030001 00 00800000 DA"),
...
{
    EXPECT_EQ(validate_eof("EF0001 030001 010004 0200010001 00 AA 08000000 FE"),
        EOFValidationError::type_section_missing);
}

TEST(eof_validation, EOF1_multiple_data_sections)
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030001 030001 00 00800000 FE DA DA"),
...
TEST(eof_validation, EOF1_unknown_section)
{
    ...
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 040001 00 00800000 FE 00"),
        EOFValidationError::data_section_missing);
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 FF0001 00 00800000 FE 00"),
        EOFValidationError::data_section_missing);
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030001 040001 00 00800000 FE AA 00"),
        EOFValidationError::header_terminator_missing);
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030001 FF0001 00 00800000 FE AA 00"),
        EOFValidationError::header_terminator_missing);
}
...
TEST(eof_validation, EOF1_truncated_section)
{
    ...
    EXPECT_EQ(validate_eof("EF0001 010004 0200010002 030000 00 008000"),
        EOFValidationError::invalid_section_bodies_size);
    EXPECT_EQ(validate_eof("EF0001 010004 0200010002 030000 00 00800000 FE"),
        EOFValidationError::invalid_section_bodies_size);
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030002 00 00800000 FE"),
        EOFValidationError::invalid_section_bodies_size);
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030002 00 00800000 FE AA"),
        EOFValidationError::invalid_section_bodies_size);
}
...
{
    const auto eof =
        "EF0001 010008 02000200030001 030004 00 00800001 00800000 6001fe fe 0000 0000"_hex;
...
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030000 00 00800000 FE DEADBEEF"),
        EOFValidationError::invalid_section_bodies_size);
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030002 00 00800000 FE AABB DEADBEEF"),
        EOFValidationError::invalid_section_bodies_size);
}
...
TEST(eof_validation, EOF1_type_section_not_first)
{
    ...
    EXPECT_EQ(validate_eof("EF0001 0200010001 010004 030003 00 FE 00800000 AABBCC"),
        EOFValidationError::type_section_missing);

    EXPECT_EQ(validate_eof("EF0001 0200010001 030003 010004 00 FE AABBCC 00800000"),
        EOFValidationError::type_section_missing);
}
...
TEST(eof_validation, EOF1_invalid_type_section_size)
{
    ...
    EXPECT_EQ(validate_eof("EF0001 010002 0200010001 030000 00 0080 FE"),
        EOFValidationError::invalid_type_section_size);
    EXPECT_EQ(validate_eof("EF0001 010008 0200010001 030000 00 0080000000000000 FE"),
        EOFValidationError::invalid_type_section_size);

    EXPECT_EQ(validate_eof("EF0001 010008 020003000100010001 030000 00 0080000000800000 FE FE FE"),
        EOFValidationError::invalid_type_section_size);
    EXPECT_EQ(
        validate_eof(
            "EF0001 010010 020003000100010001 030000 00 00800000008000000080000000800000 FE FE FE"),
        EOFValidationError::invalid_type_section_size);
}
...
TEST(eof_validation, EOF1_too_many_code_sections)
{
    const auto valid = "EF0001 011000" + bytecode{"020400"} + 0x400 * bytecode{"0001"} +
                       "030000 00" + 0x400 * bytecode{"00800000"} + 0x400 * bytecode{"FE"};
    ...
    const auto invalid = "EF0001 011002" + bytecode{"020401"} + 0x401 * bytecode{"0001"} +
                         "030000 00" + 0x401 * bytecode{"00800000"} + 0x401 * bytecode{"FE"};
...
TEST(eof_validation, EOF1_undefined_opcodes)
{
    ...
    for (uint16_t opcode = 0; opcode <= 0xff; ++opcode)
    {
        ...
        auto cont =
            "EF0001 010004 0200010014 030000 00 00800000 6001"
        ...
        if (opcode == OP_RETF)
        {
            ...
            cont = "EF0001 010008 02000200010001 030000 00 00800000 00000000 00"_hex + OP_RETF;
        }
        else
        {
...
{
    auto eof_header = "EF0001 010004 0200010001 030000 00 00800000"_hex;
...
{
    // offset = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010004 030000 00 00800000 E0000000"),
        EOFValidationError::success);

    // offset = 3
    EXPECT_EQ(validate_eof("EF0001 010004 0200010009 030000 00 00800001 E00003600100E0FFFA"),
        EOFValidationError::success);

    // offset = -4
    EXPECT_EQ(validate_eof("EF0001 010004 0200010004 030000 00 00800000 5BE0FFFC"),
        EOFValidationError::success);
}
...
{
    // offset = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800001 6000E1000000"),
        EOFValidationError::success);

    // offset = 3
    EXPECT_EQ(validate_eof("EF0001 010004 0200010009 030000 00 00800001 6000E100035B5B5B00"),
        EOFValidationError::success);

    // offset = -5
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800001 6000E1FFFB00"),
        EOFValidationError::success);
}
...
{
    // table = [0] case = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010009 030000 00 00800001 6000E2010000600100"),
        EOFValidationError::success);

    // table = [0,3] case = 0
    EXPECT_EQ(
        validate_eof("EF0001 010004 020001000E 030000 00 00800001 6000E20200000003600100600200"),
        EOFValidationError::success);

    // table = [0,3] case = 2
    EXPECT_EQ(
        validate_eof("EF0001 010004 020001000E 030000 00 00800001 6002E20200000003600100600200"),
        EOFValidationError::success);

    // table = [0,3,-10] case = 2
    EXPECT_EQ(validate_eof(
                  "EF0001 010004 0200010010 030000 00 00800001 6002E20300000003FFF6600100600200"),
        EOFValidationError::success);
}

TEST(eof_validation, EOF1_rjump_truncated)
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030000 00 00800000 E0"),
        EOFValidationError::truncated_instruction);

    EXPECT_EQ(validate_eof("EF0001 010004 0200010002 030000 00 00800000 E000"),
        EOFValidationError::truncated_instruction);
}

TEST(eof_validation, EOF1_rjumpi_truncated)
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010003 030000 00 00800000 6000E1"),
        EOFValidationError::truncated_instruction);

    EXPECT_EQ(validate_eof("EF0001 010004 0200010004 030000 00 00800000 6000E100"),
        EOFValidationError::truncated_instruction);
}
...
{
    // table = [0] case = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 030000 00 00800000 6000E20100"),
        EOFValidationError::truncated_instruction);

    // table = [0,3] case = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010007 030000 00 00800000 6000E202000000"),
        EOFValidationError::truncated_instruction);

    // table = [0,3] case = 2
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800000 6002E2020000"),
        EOFValidationError::truncated_instruction);

    // table = [0,3,-10] case = 2
    EXPECT_EQ(validate_eof("EF0001 010004 0200010009 030000 00 00800000 6002E20300000003FF"),
        EOFValidationError::truncated_instruction);
}
...
TEST(eof_validation, EOF1_rjump_invalid_destination)
{
    ...
    EXPECT_EQ(validate_eof("EF0001 010004 0200010004 030000 00 00800000 E0FFFB00"),
        EOFValidationError::invalid_rjump_destination);

    // To before code begin (offset = -13)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010004 030000 00 00800000 E0FFF300"),
        EOFValidationError::invalid_rjump_destination);

    // To after code end (offset = 2)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010004 030000 00 00800000 E0000200"),
        EOFValidationError::invalid_rjump_destination);

    // To code end (offset = 1)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010004 030000 00 00800000 E0000100"),
        EOFValidationError::invalid_rjump_destination);

    // To the same RJUMP immediate (offset = -1)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010004 030000 00 00800000 E0FFFF00"),
        EOFValidationError::invalid_rjump_destination);

    // To PUSH immediate (offset = -4)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800000 6000E0FFFC00"),
        EOFValidationError::invalid_rjump_destination);
}
...
TEST(eof_validation, EOF1_rjumpi_invalid_destination)
{
    ...
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800000 6000E1FFF900"),
        EOFValidationError::invalid_rjump_destination);

    // To before code begin (offset = -15)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800000 6000E1FFF100"),
        EOFValidationError::invalid_rjump_destination);

    // To after code end (offset = 2)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800000 6000E1000200"),
        EOFValidationError::invalid_rjump_destination);

    // To code end (offset = 1)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800000 6000E1000100"),
        EOFValidationError::invalid_rjump_destination);

    // To the same RJUMPI immediate (offset = -1)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800000 6000E1FFFF00"),
        EOFValidationError::invalid_rjump_destination);

    // To PUSH immediate (offset = -4)
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030000 00 00800000 6000E1FFFC00"),
        EOFValidationError::invalid_rjump_destination);
}
...
{
    // table = [-23] case = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010008 030000 00 00800000 6000E201FFE96001"),
        EOFValidationError::invalid_rjump_destination);

    // table = [-8] case = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010008 030000 00 00800000 6000E201FFF86001"),
        EOFValidationError::invalid_rjump_destination);

    // table = [-1] case = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010008 030000 00 00800000 6000E201FFFF6001"),
        EOFValidationError::invalid_rjump_destination);

    // table = [2] case = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010008 030000 00 00800000 6000E20100026001"),
        EOFValidationError::invalid_rjump_destination);

    // table = [3] case = 0
    EXPECT_EQ(validate_eof("EF0001 010004 0200010008 030000 00 00800000 6000E20100036001"),
        EOFValidationError::invalid_rjump_destination);


    // table = [0,3,-27] case = 2
    EXPECT_EQ(
        validate_eof("EF0001 010004 020001000F 030000 00 00800000 6002E20300000003FFE56001006002"),
        EOFValidationError::invalid_rjump_destination);

    // table = [0,3,-12] case = 2
    EXPECT_EQ(
        validate_eof("EF0001 010004 020001000F 030000 00 00800000 6002E20300000003FFF46001006002"),
        EOFValidationError::invalid_rjump_destination);

    // table = [0,3,-1] case = 2
    EXPECT_EQ(
        validate_eof("EF0001 010004 020001000F 030000 00 00800000 6002E20300000003FFFF6001006002"),
        EOFValidationError::invalid_rjump_destination);

    // table = [0,3,5] case = 2
    EXPECT_EQ(
        validate_eof("EF0001 010004 020001000F 030000 00 00800000 6002E2030000000300056001006002"),
        EOFValidationError::invalid_rjump_destination);

    // table = [0,3,6] case = 2
    EXPECT_EQ(
        validate_eof("EF0001 010004 020001000F 030000 00 00800000 6002E2030000000300066001006002"),
        EOFValidationError::invalid_rjump_destination);
}
...
{
    // 01 02 03
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 030002 00 00800001 6000E0000000 AABB"),
        EOFValidationError::success);

    // 01 03 02
    EXPECT_EQ(validate_eof("EF0001 010004 030002 0200010006 00 00800000 AABB 6000E0000000"),
        EOFValidationError::code_section_missing);

    // 02 01 03
    EXPECT_EQ(validate_eof("EF0001 0200010006 010004 030002 00 6000E0000000 00800000 AABB"),
        EOFValidationError::type_section_missing);

    // 02 03 01
    EXPECT_EQ(validate_eof("EF0001 0200010006 030002 010004 00 6000E0000000 AABB 00800000"),
        EOFValidationError::type_section_missing);

    // 03 01 02
    EXPECT_EQ(validate_eof("EF0001 030002 010004 0200010006 00 AABB 00800000 6000E0000000"),
        EOFValidationError::type_section_missing);

    // 03 02 01
    EXPECT_EQ(validate_eof("EF0001 030002 0200010006 010004 00 AABB 6000E0000000 00800000"),
        EOFValidationError::type_section_missing);
}
...
{
    EXPECT_EQ(validate_eof("EF0001 010008 02000200010001 030000 00 00800000 7F7F007F 00 E4"),
        EOFValidationError::success);

    EXPECT_EQ(validate_eof("EF0001 010008 02000200010001 030000 00 00800000 80800080 00 E4"),
        EOFValidationError::inputs_outputs_num_above_limit);

    {
        auto code = bytecode{"EF0001 010008 020002000100FF 030000 00 00800000 007F007F"} + OP_STOP +
    ...
    {
        auto code = bytecode{"EF0001 010008 02000200010103 030000 00 00800000 00810081"} + OP_STOP +
                    129 * bytecode{1} + OP_RETF;

        EXPECT_EQ(validate_eof(code), EOFValidationError::inputs_outputs_num_above_limit);
    }

    {
        auto code = bytecode{"EF0001 010008 02000200010080 030000 00 00800000 7F00007F"} + OP_STOP +
                    127 * OP_POP + OP_RETF;
    ...
    {
        auto code = bytecode{"EF0001 010008 02000200010081 030000 00 00800000 80000080"} + OP_STOP +
                    128 * OP_POP + OP_RETF;
...
{
    {
        auto code = bytecode{"EF0001 010008 02000200010BFE 030000 00 00800000 000003FF"} + OP_STOP +
    ...
    {
        auto code = "EF0001 010008 0200020BFE0001 030000 00 008003FF 00000000" +
    ...
    {
        auto code = bytecode{"EF0001 010008 02000200010C01 030000 00 00800000 00000400"} + OP_STOP +
    ...
    {
        auto code = "EF0001 010008 0200020C010001 030000 00 00800400 00000000" +
    ...
    {
        auto code = bytecode{"EF0001 010008 02000200010C01 030000 00 00800000 000003FF"} + OP_STOP +
                    0x400 * bytecode{1} + 0x400 * OP_POP + OP_RETF;
    ...
    {
        auto code = "EF0001 010008 0200020C010001 030000 00 008003FF 00000000" +
                    0x400 * bytecode{1} + 0x400 * OP_POP + OP_STOP + OP_RETF;
...
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030000 00 00800000 E3"),
        EOFValidationError::truncated_instruction);

    EXPECT_EQ(validate_eof("EF0001 010004 0200010002 030000 00 00800000 E300"),
        EOFValidationError::truncated_instruction);
}

TEST(eof_validation, callf_invalid_code_section_index)
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010004 030000 00 00800000 E3000100"),
...
{
    EXPECT_EQ(validate_eof("ef0001 010008 020001 0004 020001 0005 030000 00 00800000 045c0000 "
                           "00405c00 00002e0005"),
        EOFValidationError::data_section_missing);
}
...
{
    auto code = bytecode{"ef0001 010ffc 0203ff"} + 1023 * bytecode{"0001"} + "030000 00" +
...
{
    auto code = bytecode{"ef0001 011000 020400"} + 1024 * bytecode{"0001"} + "030000 00" +
...
{
    auto code = bytecode{"ef0001 011004 020401"} + 1025 * bytecode{"0001"} + "030000 00" +
...
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 030000 00 00800000 E9"),
        EOFValidationError::truncated_instruction);

    EXPECT_EQ(validate_eof("EF0001 010004 0200010002 030000 00 00800000 E900"),
        EOFValidationError::truncated_instruction);
}
...
{
    // DATALOADN{0}
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 030020 00 00800001 E900005000"
                           "0000000000000000111111111111111122222222222222223333333333333333"),
        EOFValidationError::success);

    // DATALOADN{1}
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 030021 00 00800001 E900015000"
                           "000000000000000011111111111111112222222222222222333333333333333344"),
        EOFValidationError::success);

    // DATALOADN{32}
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 030040 00 00800001 E900205000"
                           "0000000000000000111111111111111122222222222222223333333333333333"
                           "0000000000000000111111111111111122222222222222223333333333333333"),
        EOFValidationError::success);

    // DATALOADN{0} - no data section
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 030000 00 00800001 E900005000"),
        EOFValidationError::invalid_dataloadn_index);

    // DATALOADN{1} - out of data section bounds
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 030001 00 00800001 E900015000"
                           "00"),
        EOFValidationError::invalid_dataloadn_index);

    // DATALOADN{32} - out of data section bounds
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 030020 00 00800001 E900205000"
                           "0000000000000000111111111111111122222222222222223333333333333333"),
        EOFValidationError::invalid_dataloadn_index);

    // DATALOADN{uint16_max} - out of data section bounds
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 030020 00 00800001 E9ffff5000"
                           "0000000000000000111111111111111122222222222222223333333333333333"),
        EOFValidationError::invalid_dataloadn_index);

    // DATALOADN{32} - truncated word
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 03003F 00 00800001 E900205000"
                           "0000000000000000111111111111111122222222222222223333333333333333"
